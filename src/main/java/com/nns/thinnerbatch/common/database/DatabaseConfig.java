package com.nns.thinnerbatch.common.database;
...
@Configuration
@EnableJpaRepositories({"com.nns.thinnerbatch.repository"})
...
public class DatabaseConfig {
	...
	public DataSource dataSource(
		@Qualifier("readWriteDataSource") DataSource readWriteDataSource, @Qualifier("readOnlyDataSource") DataSource readOnlyDataSource
	){
